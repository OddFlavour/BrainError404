...
public class LargestDivisibleSubset {
    ...
    public List<Integer> largestDivisibleSubset(int[] nums) {
        ...
        // Instead of constructing a ton of ArrayLists, we can keep track of the length of the longest subset
        // Then we construct one ArrayList at the end
        ...
        // Here we construct the one ArrayList, going backwards, because if the largest is divisible then
        // its precedents must also be divisible
        List<Integer> ans = new ArrayList<>();
